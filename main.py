...
choose_points: int = 0  # 0 Генерировать ли случайные числа, 1 10 чисел, 2 20 чисел
...
tournament_size: int = 10  # Количество агентов для отбора

# Задание точек маршрута
if choose_points == 0:
    points: List[Tuple[int, int]] = generate_random_points((0, 0), (512, 512), num_random_points)
    ...
    points: List[Tuple[int, int]] = [(139, 113), (195, 252), (21, 494), (45, 407), (43, 280), (49, 340), (338, 31),
